...
Hashira::ShaderHelper::ShaderHelper()
{
...
Microsoft::WRL::ComPtr<ID3DBlob>& Hashira::ShaderHelper::GetShader(ShaderHelper::SHADER_TYPE type)
{
...
void Hashira::ShaderHelper::AddShaderMacro(std::string name, std::string definition)
{
...
void Hashira::ShaderHelper::EraseShaderMacro(std::string name)
{
...
const std::vector<D3D_SHADER_MACRO>& Hashira::ShaderHelper::GetShaderMacro() const
{
	return _shaderMacro;
}

HRESULT Hashira::ShaderHelper::CompileShader(SHADER_TYPE type, std::string shaderPath, std::string functionName, std::string shaderMode)
{
#if defined(_DEBUG)
