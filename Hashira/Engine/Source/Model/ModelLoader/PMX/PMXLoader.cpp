...
std::shared_ptr<K3D::PMXModel> K3D::PMXLoader::Load(std::string modelPath)
{
	if (modelPath.empty()) {
		return nullptr;
	}
	...
	std::shared_ptr<K3D::PMXModel> model = std::make_shared<K3D::PMXModel>();
...
void K3D::PMXLoader::LoadInfo(FILE * fp, PMXModel * model)
{
...
void K3D::PMXLoader::LoadVertex(FILE * fp, PMXModel * model)
{
...
void K3D::PMXLoader::LoadSurface(FILE * fp, PMXModel * model)
{
...
void K3D::PMXLoader::LoadTexture(FILE * fp, PMXModel * model)
{
	int textureCount = 0;
...
void K3D::PMXLoader::LoadMaterials(FILE * fp, PMXModel * model)
{
...
void K3D::PMXLoader::LoadBone(FILE * fp, PMXModel * model)
{
...
void K3D::PMXLoader::LoadMorph(FILE * fp, PMXModel * model)
{
...
void K3D::PMXLoader::LoadDisplay(FILE * fp, PMXModel * model)
{
...
void K3D::PMXLoader::LoadRigidBody(FILE * fp, PMXModel * model)
{
...
void K3D::PMXLoader::LoadJoint(FILE * fp, PMXModel * model)
{
